...
// [速率限制]是控制资源利用和维护服务质量的重要机制。
// Go elegantly supports rate limiting with goroutines,channels, and [tickers](tickers).
// Go使用goroutines、channel和[tickers](tickers)来优雅地支持速率限制。
